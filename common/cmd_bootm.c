...
// #define show_boot_progress(i); printf("boot step %d\n", i);
static int bootm_start(cmd_tbl_t *cmdtp, int flag, int argc, char *argv[])
{
	...
	//printf("find kernel entry point\n");
	if (images.legacy_hdr_valid) {

		images.ep = image_get_ep (&images.legacy_hdr_os_copy);
		//printf("get legacy_hdr_valid images.ep %d\n", images.ep);
#if defined(CONFIG_FIT)
...
static int bootm_load_os(image_info_t os, ulong *load_end, int boot_progress)
{
	...
	//printf("bootm_load_os comp %d, load %x, blob_start %d, type_name %d\n", comp, load, blob_start, type_name);
