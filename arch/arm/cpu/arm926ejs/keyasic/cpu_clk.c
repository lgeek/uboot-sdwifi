...
int pll_ratio(int input, int type)
{
    ...
    switch(input)
    {
        case 0:     result = type ? 0 : 1;  break;
        case 1:     result = type ? 0 : 2;  break;
        case 2:     result = type ? 1 : 3;  break;
        case 3:     result = type ? 2 : 1;  break;
        case 4:     result = 4;             break;
        case 6:     result = type ? 8 : 1;  break;
        case 8:     result = type ? 8 : 6;  break;
        case 10:    result = type ? 0 : 8;  break;
        default:    result = type ? 0 : 1;          break;
    }
    return result;
}
