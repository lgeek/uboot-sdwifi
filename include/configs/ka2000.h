...
#define BOOT_FROM_SD                        /* load image and initramfs.gz from SD */
#define BOOT_LONG_DELAY 50                  /* set long boot delay */
#define AUTO_BOOT 0                         /* stay at u-boot console, no auto boot kernel */

#if AUTO_BOOT
#if  BOOT_LONG_DELAY
#define CONFIG_BOOTDELAY		50				/*Delay (sec) b4 autoboot image, -1 disable autoboot */
#else
...
#define CONFIG_SYS_CLK_FREQ		240000000 //96000000			/*ARM clock freq, input clock of PLL */
#else
...
#define CONFIG_SYS_UART_CLK		(CONFIG_SYS_CLK_FREQ/CONFIG_HCLK_RATIO)
...
#define CONFIG_EXTRA_ENV_SETTINGS       \
	...
	"boot_sd=run set_bootargs; mmc init; fatload mmc 1 208000 image; fatload mmc 1 600000 initramfs.gz; go 208000\0"	\
